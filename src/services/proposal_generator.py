...
class ProposalGenerator:
    ...
    def generate_proposal(
        self, client_data: Dict[str, Any], analysis_data: Dict[str, Any]
    ) -> MarketingProposal:
        ...
        situation_analysis = self._generate_situation_analysis(
            client_data, analysis_data
        )
    ...
    def _generate_executive_summary(
        ...
        main_challenges = (
            ", ".join(challenges[:3]) if challenges else "Crescimento sustentável"
        )
    ...
    def _generate_situation_analysis(
        ...
        opportunities = [
            i.descricao for i in insights if i.categoria == "Oportunidade"
        ][:3]
...
"""
    ...
    def _generate_strategies(
        ...
        for i, insight in enumerate(
            high_priority_insights[:4], 1
        ):  # Máximo 4 estratégias
            strategy = MarketingStrategy(
                ...
                investimento_estimado=self._estimate_strategy_investment(
                    insight, client_data
                ),
    ...
    def _generate_timeline(self, strategies: List[MarketingStrategy]) -> Dict[str, Any]:
        ...
        timeline = {"phases": [], "total_duration": "24 semanas", "milestones": []}
    ...
    def _generate_investment_breakdown(
        self, client_data: Dict[str, Any], strategies: List[MarketingStrategy]
    ) -> Dict[str, Any]:
        ...
        if not metrics:
            ...
            if objective == "Aumentar vendas":
                ...
                metrics = [
                    ...
                    {
                        "metric": "Taxa de conversão leads",
                        "target": "+30%",
                        "period": "6 meses",
                    },
                ]
    ...
    def _generate_competition_analysis(self, sector: str) -> str:
        ...
        return competition_analysis.get(
            sector,
            "Análise detalhada da concorrência será realizada na fase de implementação.",
        )
    ...
    def _generate_implementation_plan(
        self, insight, client_data: Dict[str, Any]
    ) -> str:
    ...
    def _estimate_strategy_investment(
        self, insight, client_data: Dict[str, Any]
    ) -> str:
    ...
    def _estimate_strategy_roi(self, insight) -> str:
        ...
        roi_map = {"Alta": "200-300%", "Média": "150-200%", "Baixa": "120-150%"}
        return roi_map.get(insight.prioridade, "150-200%")

    def _define_strategy_metrics(
        self, insight, client_data: Dict[str, Any]
    ) -> List[str]:
