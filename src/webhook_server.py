...
def executar_analise_automatica(dados_cliente):
    ...
    try:
        ...
        resultado = {
            ...
            "proposta": proposta.__dict__
            if hasattr(proposta, "__dict__")
            else proposta,
...
def webhook_tally():
    ...
    try:
        ...
        if resultado_analise:
            ...
            filename = (
                f"{DATA_DIR}/dados_brutos_{dados_processados['submission_id']}.json"
            )
            with open(filename, "w", encoding="utf-8") as f:
...
if __name__ == "__main__":
    ...
    print("Endpoint principal: http://localhost:5000/webhook/tally")
    print("Endpoint teste: http://localhost:5000/webhook/test")
    print("Listar submissões: http://localhost:5000/submissions")
